...
def seed_menus(*, session: Session) -> list[Menu]:
    ...
    button_permissions = [
        ...
        (erp_stock_other_in.id, "审核其他入库", "erp:stock-in:approve", 2),
        (erp_stock_other_in.id, "反审核其他入库", "erp:stock-in:reverse", 3),
        (erp_stock_other_in.id, "导出其他入库", "erp:stock-in:export", 4),
        (erp_stock_other_out.id, "新建其他出库", "erp:stock-out:create", 1),
        (erp_stock_other_out.id, "审核其他出库", "erp:stock-out:approve", 2),
        (erp_stock_other_out.id, "反审核其他出库", "erp:stock-out:reverse", 3),
        (erp_stock_other_out.id, "导出其他出库", "erp:stock-out:export", 4),
        (erp_stock_move.id, "新建库存调拨", "erp:stock-move:create", 1),
        (erp_stock_move.id, "审核库存调拨", "erp:stock-move:approve", 2),
        (erp_stock_move.id, "反审核库存调拨", "erp:stock-move:reverse", 3),
        (erp_stock_move.id, "导出库存调拨", "erp:stock-move:export", 4),
        (erp_stock_check.id, "新建库存盘点", "erp:stock-check:create", 1),
        (erp_stock_check.id, "审核库存盘点", "erp:stock-check:approve", 2),
        (erp_stock_check.id, "反审核库存盘点", "erp:stock-check:reverse", 3),
        (erp_stock_check.id, "导出库存盘点", "erp:stock-check:export", 4),
        ...
        (erp_finance_payments.id, "审核付款单", "erp:finance-payment:approve", 2),
        (erp_finance_payments.id, "反审核付款单", "erp:finance-payment:reverse", 3),
        (erp_finance_payments.id, "导出付款单", "erp:finance-payment:export", 4),
        (erp_finance_receipts.id, "新建收款单", "erp:finance-receipt:create", 1),
        (erp_finance_receipts.id, "审核收款单", "erp:finance-receipt:approve", 2),
        (erp_finance_receipts.id, "反审核收款单", "erp:finance-receipt:reverse", 3),
        (erp_finance_receipts.id, "导出收款单", "erp:finance-receipt:export", 4),
        ...
        (erp_purchase_ins.id, "审核采购入库", "erp:purchase-in:approve", 2),
        (erp_purchase_ins.id, "反审核采购入库", "erp:purchase-in:reverse", 3),
        (erp_purchase_ins.id, "导出采购入库", "erp:purchase-in:export", 4),
        (erp_purchase_returns.id, "新建采购退货", "erp:purchase-return:create", 1),
        (erp_purchase_returns.id, "审核采购退货", "erp:purchase-return:approve", 2),
        (erp_purchase_returns.id, "反审核采购退货", "erp:purchase-return:reverse", 3),
        (erp_purchase_returns.id, "导出采购退货", "erp:purchase-return:export", 4),
        ...
        (erp_sale_outs.id, "审核销售出库", "erp:sale-out:approve", 2),
        (erp_sale_outs.id, "反审核销售出库", "erp:sale-out:reverse", 3),
        (erp_sale_outs.id, "导出销售出库", "erp:sale-out:export", 4),
        (erp_sale_returns.id, "新建销售退货", "erp:sale-return:create", 1),
        (erp_sale_returns.id, "审核销售退货", "erp:sale-return:approve", 2),
        (erp_sale_returns.id, "反审核销售退货", "erp:sale-return:reverse", 3),
        (erp_sale_returns.id, "导出销售退货", "erp:sale-return:export", 4),
